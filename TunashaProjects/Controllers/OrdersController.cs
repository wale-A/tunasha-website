...
namespace TunashaProjects.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public ActionResult Details(string transactionNo)
        {
            if (transactionNo == "")
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            Order order = db.Orders.SingleOrDefault(x => x.TransactionNumber == transactionNo);
            if (order == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "ID,CustomerName,CustomerAddress,CustomerPhone,Date,TransactionNumber")] Order order)
        {
